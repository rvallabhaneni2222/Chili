...
//      private XWPFStyles styles;
    public DocxConverter(final InputStream in) throws IOException, InvalidFormatException, ParserConfigurationException {
...
//              set page framework style
    ...
    public static String convert(final InputStream in) throws Exception {
        ...
        DocxConverter converter = new DocxConverter(in);
...
//              System.out.println(pages);
        ...
        return getStringFromDoc(converter.htmlDocumentFacade.getDocument());
...
//              check path
    ...
    /**
     * add the given style to element directly. <tag style="..." @par
     *
     *
     * am element @param style
     */
